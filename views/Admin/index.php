			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
						...
						<a href="edit.php" class ="btn btn-primary pull-right">More information about Prank</a>
						</div>
...
app.controller("MyServicesController", ['$scope', "$http" , function($scope, $http){
	...
	$scope.gridModel.columnDefs = [
									{field: 'View',  enableColumnMenu: false, enableFiltering: false, width: 53, cellTemplate: '<a class="btn btn-primary" role="button" ng-href="edit.php?id={{row.entity.id}}">View</a>'},
